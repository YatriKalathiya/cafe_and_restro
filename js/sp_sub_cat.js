...
function subcat_load(){
    ...
    id.innerHTML = sub_cat_data.map((el,id)=>{
        return `<a href='./category_list.html' class="col d-flex justify-content-center pb-5">
                <div class="sp_sub_cat_content">
                    <div class="sp_sub_cat_img ${id==0 ? `border-white`:''}">
